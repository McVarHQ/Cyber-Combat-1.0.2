...
def game_over():
    ...
    try:
        with open((os.path.join(filepath, 'score6.dat')), 'rb') as file:
    ...
    with open((os.path.join(filepath, 'score6.dat')), 'wb') as file:
...
bgimg = pygame.image.load(os.path.join(filepath, 'icons/bg562.png'))
...
estart_pos = [[988, 525], [1433, 291], [1931, 534], [2416, 285], [2896, 283], [3498, 421], [4085, 527],
              [4612, 289], [5115, 402], [5672, 289], [6192, 535], [6507, 375]]

loc = [[988, 525], [1433, 291], [1931, 534], [2416, 285], [2896, 283], [3498, 421], [4085, 527],
       [4612, 289], [5115, 402], [5672, 289], [6192, 535], [6507, 375]]
...
while running:
    ...
    if enemy_list == []:
        if boss:
            ...
            g_spritelist = []
            g_grenade = []
            j = ['crusher', loc[0], sc_health]
            enemy_list.append(j)
            g_sprite = pygame.sprite.Sprite
            g_sprite.image = grimg_r
            g_sprite.rect = pygame.Rect(j[1][0], j[1][1], soldier_dx, soldier_dy)
            g_spritelist.append(g_sprite)
            bgimg = pygame.image.load(os.path.join(filepath, 'icons/boss-bg.png'))
            bg_ht = 750
            bg_wd = 1500
            boss_img = pygame.image.load(os.path.join(filepath, 'icons/boss-fight.png'))
            grenade2_img=pygame.image.load(os.path.join(filepath, 'icons/grenade3.png.png'))
            screen.blit(boss_img, (500, 125))
            pygame.display.update()
            screen.fill(arcade.color.BLACK)
            time.sleep(5)
            boss = True
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:
            ...
            if event.key == pygame.K_2:
                pwimg_r = pygame.image.load(os.path.join(filepath, 'icons/sword_r.png'))
                pwimg_rf = pygame.image.load(os.path.join(filepath, 'icons/sword_rf.png'))
                pwimg_l = pygame.image.load(os.path.join(filepath, 'icons/sword_l.png'))
                pwimg_lf = pygame.image.load(os.path.join(filepath, 'icons/sword_lf.png'))
                player_range = 100
                agentgun_damage = 50
                weapon = 'sword'
                ammo = 5
                shm = pygame.mixer.Sound(os.path.join(filepath, 'music/slash.wav'))
    ...
    for i in enemy_list:
        ...
        screen.blit(guard_img, (i[1][0], i[1][1]))
        if i[0] == 'grguard':
